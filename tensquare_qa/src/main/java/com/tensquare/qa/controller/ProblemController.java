...
public class ProblemController {
    ...
    public Result findNewListByLabelId(@PathVariable String labelId, @PathVariable int page, @PathVariable int size) {
        ...
        Page<Problem> pageData = problemService.findNewListByLabelId(labelId, pageable);
        return new Result(StatusCode.OK, true, "查询成功", new PageResult<Problem>(pageData.getTotalElements(), pageData.getContent()));
    }
